...
namespace FastFood.DataProcessor
{
    public static class Deserializer
    {
        ...
        public static string ImportEmployees(FastFoodDbContext context, string jsonString)
        {
            ...
            var deserializedEmployess = JsonConvert.DeserializeObject<EmployeeDto[]>(jsonString);
            foreach (var employeeDto in deserializedEmployess)
            {
        ...
        public static string ImportItems(FastFoodDbContext context, string jsonString)
        {
            ...
            var deserializedEmployess = JsonConvert.DeserializeObject<ItemDto[]>(jsonString);
            foreach (var itemDto in deserializedEmployess)
            {
                if (!IsValid(itemDto))
                {
                    sb.AppendLine(FailureMessage);
